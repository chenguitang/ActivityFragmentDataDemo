package com.greetty.datatransfer.util;
...
public class Functions {
    ...
    /**
     * 添加带参数的函数
     * @param function {@link com.greetty.datatransfer.util.Functions.FunctionWithParam}
     * @return
     */
    ...
    /**
     * 添加带返回值的函数
     * @param function {@link com.greetty.datatransfer.util.Functions.FunctionWithResult}
     * @return
     */
    ...
    /**
     * 添加既有参数又有返回值的函数
     * @param function {@link com.greetty.datatransfer.util.Functions.FunctionWithParamAndResult}
     * @return
     */
